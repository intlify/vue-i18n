...
This changelog is generated by [GitHub Releases](https://github.com/intlify/vue-i18n/releases/tag/v12.0.0-alpha.4)

<!-- Release notes generated using configuration in .github/release.yml at v12.0.0-alpha.4 -->

## What's Changed
### 🌟 Features
* Part options support for $n by @mauryapari in https://github.com/intlify/vue-i18n/pull/2170
* feat: Part options support $d by @mauryapari in https://github.com/intlify/vue-i18n/pull/2177
* feat: compatible Vue3 vapor mode by @kazupon in https://github.com/intlify/vue-i18n/pull/2299
* feat(message-compiler): support escape sequence by @kazupon in https://github.com/intlify/vue-i18n/pull/2394
* feat!: Support automatic pluralization with `Intl.PluralRules` by @kazupon in https://github.com/intlify/vue-i18n/pull/2400
* feat: support isolated scope by @kazupon in https://github.com/intlify/vue-i18n/pull/2404
### 🐛 Bug Fixes
* fix: cannot resolve the ast messages which has json path by @kazupon in https://github.com/intlify/vue-i18n/pull/2157
* fix(typing): n() & d() output depending "part" option by @pinguet62 in https://github.com/intlify/vue-i18n/pull/2193
* Fix declaration order in Number formatting with options ResourceKeys must be before OptionsType by @louis49 in https://github.com/intlify/vue-i18n/pull/2205
* Fix: Adjust stub file paths for accurate resolution during rolldown build by @babu-ch in https://github.com/intlify/vue-i18n/pull/2217
* fix: revert vue devtools timeline listening code by @kazupon in https://github.com/intlify/vue-i18n/pull/2359
* fix(core-base): throw error when has string prototype key by @kazupon in https://github.com/intlify/vue-i18n/pull/2402
* fix(core-base): key paths containing javascript built-ins are handled inconsistently by @kazupon in https://github.com/intlify/vue-i18n/pull/2403
* fix: wrong $d type by @kazupon in https://github.com/intlify/vue-i18n/pull/2405
* fix: export conditions for node.js by @kazupon in https://github.com/intlify/vue-i18n/pull/2408
* fix: te returns false if the key contains a do by @kazupon in https://github.com/intlify/vue-i18n/pull/2409
* fix: modifiers skip missing translation keys by @kazupon in https://github.com/intlify/vue-i18n/pull/2412
* fix: Numeric named parameter overwrites plural parameter in pluralization by @kazupon in https://github.com/intlify/vue-i18n/pull/2413
* fix: Suppressing automatic locale fallback with ! breaks `n/$n` and `d/$d` formatting by @kazupon in https://github.com/intlify/vue-i18n/pull/2418
* fix: Resource Keys completion does not work with global messages and $t by @kazupon in https://github.com/intlify/vue-i18n/pull/2421
* fix: `$n` overloads use `DefineNumberFormat` instead of `DefineDateTimeFormat` by @babu-ch in https://github.com/intlify/vue-i18n/pull/2459
* fix: linked messages fail to resolve keys containing dots by @babu-ch in https://github.com/intlify/vue-i18n/pull/2458
* fix: backport CVE-2025-53892 (escapeParameterHtml DOM XSS hardening) to master by @vulgraph in https://github.com/intlify/vue-i18n/pull/2470
### 💥 Breaking Changes
* breaking: update component injection APIs for drop legacy by @kazupon in https://github.com/intlify/vue-i18n/pull/2176
* breaking: change MissingHandler 2nd parameter by @kazupon in https://github.com/intlify/vue-i18n/pull/2358
* breaking: deprecate `register*` global functions in favor of `createI18n` options by @kazupon in https://github.com/intlify/vue-i18n/pull/2445
* chore!: drop Node.js 20 support by @kazupon in https://github.com/intlify/vue-i18n/pull/2487
### ⚡ Improvement Features
* fix: update slot key filtering to exclude internal keys by @edison1105 in https://github.com/intlify/vue-i18n/pull/2167
* fix: improvement `n` and `$n` typings by @kazupon in https://github.com/intlify/vue-i18n/pull/2174
* Named, list, modifier examples by @mauryapari in https://github.com/intlify/vue-i18n/pull/2186
* fix: error on duplicate useI18n calling on local scope by @kazupon in https://github.com/intlify/vue-i18n/pull/2204
* fix: typo by @kazupon in https://github.com/intlify/vue-i18n/pull/2222
* Emit INVALID_TOKEN_IN_PLACEHOLDER on invalid palceholder token by @lutejka in https://github.com/intlify/vue-i18n/pull/2252
* fix: include `vitest/node` types to fix Vitest 4 type errors by @haoqunjiang in https://github.com/intlify/vue-i18n/pull/2303
* fix: `useI18n` implementation with provide-inject fully by @kazupon in https://github.com/intlify/vue-i18n/pull/2357
* refactor: reduce variable assignments and function calls by @BobbieGoede in https://github.com/intlify/vue-i18n/pull/2392
* fix: display message commpiler error strictly by @kazupon in https://github.com/intlify/vue-i18n/pull/2410
* fix: te function returns false although fallback exists by @kazupon in https://github.com/intlify/vue-i18n/pull/2416
* fix: Usage of `n()` and `$n()` with `undefined` should not throw errors by @kazupon in https://github.com/intlify/vue-i18n/pull/2417
* docs: add possible errors for number/datetime formatter APIs by @mitre88 in https://github.com/intlify/vue-i18n/pull/2424
* fix(i18n-t): pass component children as slots by @kazupon in https://github.com/intlify/vue-i18n/pull/2475
### 🔒 Security Fixes
* security(ci): harden workflows and add zizmor audit by @kazupon in https://github.com/intlify/vue-i18n/pull/2489
### 📈 Performance Fixes
* perf: use `shallowRef` server-side for `datetimeFormats` by @BobbieGoede in https://github.com/intlify/vue-i18n/pull/2333
* fix: enable the minify selecting option by @kazupon in https://github.com/intlify/vue-i18n/pull/2356
### 📝️ Documentations
* Fix typos in CHANGELOG by @NoelDeMartin in https://github.com/intlify/vue-i18n/pull/2151
* docs: llms friendly text generation by @kazupon in https://github.com/intlify/vue-i18n/pull/2168
* docs: fix typo in pluralization.md by @KonRatt in https://github.com/intlify/vue-i18n/pull/2184
* docs: replace Legacy API usage with Composition API usage by @BobbieGoede in https://github.com/intlify/vue-i18n/pull/2196
* Update StackBlitz link in getting started guide by @babu-ch in https://github.com/intlify/vue-i18n/pull/2218
* docs: update v8 docs links to point to legacy site by @babu-ch in https://github.com/intlify/vue-i18n/pull/2227
* docs: Add SSR configuration guide for vue-i18n plugin by @babu-ch in https://github.com/intlify/vue-i18n/pull/2262
* Update component.md to explain it doesn't work in petite vue by @riderx in https://github.com/intlify/vue-i18n/pull/2259
* docs: fix typos in docs by @kianmeng in https://github.com/intlify/vue-i18n/pull/2279
* docs: add Chinese and Japanese documentation translations by @fonghehe in https://github.com/intlify/vue-i18n/pull/2390
* fix typoes, broken `rt` link by @Nikita0x in https://github.com/intlify/vue-i18n/pull/2393
* docs: update v12 migration guide by @kazupon in https://github.com/intlify/vue-i18n/pull/2395
* docs: add v11 pages by @kazupon in https://github.com/intlify/vue-i18n/pull/2396
* docs: revise docs for v12 by @kazupon in https://github.com/intlify/vue-i18n/pull/2397
* docs: fix wrong plural usage by @kazupon in https://github.com/intlify/vue-i18n/pull/2401
* docs: improve petite-vue-i18n resource key handling by @kazupon in https://github.com/intlify/vue-i18n/pull/2414
* docs: improve unplugin-vue-i18n options explanation by @kazupon in https://github.com/intlify/vue-i18n/pull/2419
* docs: more details for `availableLocales` by @kazupon in https://github.com/intlify/vue-i18n/pull/2420
### 🍭 Examples
* examples: Storybook Example with vue3 and vite by @mauryapari in https://github.com/intlify/vue-i18n/pull/2173

## New Contributors
* @NoelDeMartin made their first contribution in https://github.com/intlify/vue-i18n/pull/2151
* @edison1105 made their first contribution in https://github.com/intlify/vue-i18n/pull/2167
* @KonRatt made their first contribution in https://github.com/intlify/vue-i18n/pull/2184
* @louis49 made their first contribution in https://github.com/intlify/vue-i18n/pull/2205
* @kitsiosk made their first contribution in https://github.com/intlify/vue-i18n/pull/2226
* @autologie made their first contribution in https://github.com/intlify/vue-i18n/pull/2228
* @lutejka made their first contribution in https://github.com/intlify/vue-i18n/pull/2252
* @riderx made their first contribution in https://github.com/intlify/vue-i18n/pull/2259
* @kianmeng made their first contribution in https://github.com/intlify/vue-i18n/pull/2279
* @kbegiedza made their first contribution in https://github.com/intlify/vue-i18n/pull/2282
* @haoqunjiang made their first contribution in https://github.com/intlify/vue-i18n/pull/2303
* @fonghehe made their first contribution in https://github.com/intlify/vue-i18n/pull/2390
* @Nikita0x made their first contribution in https://github.com/intlify/vue-i18n/pull/2393
* @mitre88 made their first contribution in https://github.com/intlify/vue-i18n/pull/2424
* @vulgraph made their first contribution in https://github.com/intlify/vue-i18n/pull/2470

**Full Changelog**: https://github.com/intlify/vue-i18n/compare/v12.0.0-alpha.2...v12.0.0-alpha.4


# v12.0.0-alpha.3 (2025-07-02T15:15:01Z)

This changelog is generated by [GitHub Releases](https://github.com/intlify/vue-i18n/releases/tag/v12.0.0-alpha.3)
...
**Full Changelog**: https://github.com/intlify/vue-i18n/compare/v12.0.0-alpha.2...v12.0.0-alpha.3

# v12.0.0-alpha.2 (2025-03-20T05:28:56Z)

This changelog is generated by [GitHub Releases](https://github.com/intlify/vue-i18n/releases/tag/v12.0.0-alpha.2)
...
This changelog is generated by [GitHub Releases](https://github.com/intlify/vue-i18n/releases/tag/v12.0.0-alpha.1)
...
- feat: reactive `availableLocales` using computed property by @mnenie in https://github.com/intlify/vue-i18n/pull/2058
- feat: configurable `ComponentCustomProperties['$i18n']` type by @BobbieGoede in https://github.com/intlify/vue-i18n/pull/2093
...
- feat!: change to `mangle` option name from `minify` option name by @kazupon in https://github.com/intlify/vue-i18n/pull/2064
...
- docs: clarify `v-t` limitations and reactivity behavior by @docnoe in https://github.com/intlify/vue-i18n/pull/2118
