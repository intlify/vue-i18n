...
As described in "[Different Distribution files](/guide/extra/dist#from-cdn-or-without-a-bundler)" section, Vue I18n offer the following two built ES modules for Bundler.
