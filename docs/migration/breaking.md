...
Most of Vue I18n API has remained unchanged during its rewrite from v8 (for Vue 2) to v9 (for Vue 3) but there are still a few breaking changes that you might encounter while migrating your application. This guide is how to adapt your application to make it work with Vue I18n v9.
