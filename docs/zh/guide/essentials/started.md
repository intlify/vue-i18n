...
例如，如果您使用的是 [Vue](https://vuejs.org/guide/quick-start.html#using-vue-from-cdn) 和 [Vue I18n](../installation#Direct-Download-CDN) 的全局构建版本，这些库会通过全局对象暴露，而不是通过模块导入的方式来使用：
