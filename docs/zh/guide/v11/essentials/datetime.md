...
> [!NOTE]
> 请注意，在 VueI18n v9 中，选项名称是 **`datetimeFormats`**，而不是 `dateTimeFormats`。要了解更多详细信息，请访问 [迁移指南](/zh/guide/migration/breaking#rename-to-datetimeformats-from-datetimeformats)。
...
> [!NOTE]
> 支持的作用域插槽的完整列表以及其他 `i18n-d` 属性可以在 [API 参考](/api/general/variables/DatetimeFormat.md) 中找到。
