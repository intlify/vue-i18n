...
/**
 *
 * The interface used for narrowing the Composer type using generated types.
 *
 * @remarks
 *
 ...
 * @example
 * ```ts
 * // generated-vue-i18n.d.ts (`.d.ts` file at your app)
 *
 * declare module 'vue-i18n' {
 *   interface ComposerGeneratedTypeConfig {
 *     // based on configuration elsewhere
 *     locale: "en" | "ja"
 *   }
 * }
 * ```
...
export interface Composer<
  ...
  Locales = IsNever<GeneratedLocale> extends true
