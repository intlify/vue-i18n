...
test('components type check', () => {
  ...
  expectTypeOf(<Translation tag="span" keypath={'foo.bar'} />).toEqualTypeOf<JSX.Element>()
  expectTypeOf(<NumberFormat format={'foo.bar'} value={1000} />).toEqualTypeOf<JSX.Element>()
  expectTypeOf(
